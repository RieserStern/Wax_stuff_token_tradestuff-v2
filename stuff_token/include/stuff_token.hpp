...
namespace eosio {
   ...
   /**
    * @defgroup eosiotoken stuff_token
    * @ingroup eosiocontracts
    * 
    * stuff_token contract
    * 
    * @details stuff_token contract defines the structures and actions that allow users to create, issue, and manage 
    * tokens on eosio based blockchains.
    * @{
    */
   class [[eosio::contract("stuff_token")]] token : public contract {
      public:
   ...
   /** @}*/ // end of @defgroup eosiotoken stuff_token
} /// namespace eosio
